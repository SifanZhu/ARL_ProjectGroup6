...
(`--seeds`, default `0 1 2 3 4`) with 1M timesteps and showing:
...
Trained models with seed 0-4 at 1M timesteps and the corresponding checkpoints must be avaiable in the current folder, if we want to regenerate the polts.
